...
distribution in 2010. The list is obtained from data_preparation_pwt_71_2010.py.
'
...
countries <- read.csv(
	paste(PATH_OUT_DATA, 'countries_2010.csv', sep="/"), sep=',', header=FALSE
)
...
pdf(paste(PATH_OUT_FIGURES, "fig_map_included_countries_2010.pdf", sep="/"))
mapCountryData(
